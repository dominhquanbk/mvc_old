...
include "../../../MVC/App/Controllers/SignUp.php";
            ...
            <div class="row d-flex align-items-center justify-content-center h-100">
                ...
                <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                    <form method="POST">
                        ...
                        <!-- Submit button -->
                        <button type="submit" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg btn-block" name="submit">Sign Up</button>
                        <!-- Sign in -->
